...
if (isset($_POST["sign-up"])) {
    ...
    if ($picture !== null && $_FILES["picture"]["error"] == 0) {
        ...
        $sql = "UPDATE users SET first_name = '$firstname', last_name = '$lastname', email = '$email', date_of_birth = '$date_of_birth', phone_number = '$phone_number',  picture = '$picture[0]', WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET first_name = '$firstname', last_name = '$lastname', date_of_birth = '$date_of_birth', email = '$email', phone_number = '$phone_number' WHERE id = {$id}";
    }
